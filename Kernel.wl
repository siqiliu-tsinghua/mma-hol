...
Module[{
    arityTable, constTypeTable, axiomList, defnList, axiomIntakeOpen,
    thmTag,
    tyMatch, registerConst,
    destEq, normHyps, mergeHyps, removeHyp, hypContainsFree,
    tyvarsInTerm, betaSubst,
    validateVarName, validateTypeName
  },
